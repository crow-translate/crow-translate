...
#ifndef UNIXCONFIGAUTOSTARTMGR_H
#define UNIXCONFIGAUTOSTARTMGR_H

#include "abstractautostartmgr.h"

class UnixConfigAutostartMgr : public AbstractAutostartMgr
{
    Q_OBJECT
    Q_DISABLE_COPY(UnixConfigAutostartMgr)
...
#endif // UNIXCONFIGAUTOSTARTMGR_H
