    ...
    , m_rootItem(new ShortcutItem(this))
{
    ...
    m_pauseSpeakingShortcut = new ShortcutItem(tr("Pause / unpause text speaking"), QStringLiteral("media-playback-pause"), m_globalShortcuts);
    m_pauseSpeakingShortcut->setDefaultShortcut(AppSettings::defaultPauseSpeakingShortcut());
...
void ShortcutsModel::loadShortcuts(const AppSettings &settings)
{
    ...
    m_pauseSpeakingShortcut->setShortcut(settings.pauseSpeakingShortcut());
...
void ShortcutsModel::saveShortcuts(AppSettings &settings) const
{
    ...
    settings.setPauseSpeakingShortcut(m_pauseSpeakingShortcut->shortcut());
